---
{
  "title": "Imagem do Hubble mostra como estrelas remodelam a nebulosa N44",
  "slug": "hubble-n44-estrelas",
  "description": "Na Grande Nuvem de Magalhães, uma cavidade cercada por gás concentra pistas sobre o nascimento de novas estrelas.",
  "quickTakeaways": [
    "N44 fica na Grande Nuvem de Magalhães, a cerca de 160 mil anos-luz.",
    "Ventos estelares e supernovas abriram uma grande cavidade no gás.",
...
A cavidade central, chamada de superbolha, mede cerca de 210 por 140 anos-luz. Ela foi aberta por ventos intensos de estrelas e por explosões de supernovas. Ao expulsar o material ao redor, esses processos deixaram o interior mais vazio e comprimiram o gás em uma espécie de casca.

## Uma região, diferentes gerações de estrelas

É nessa borda comprimida que outras estrelas estão se formando. A região ajuda os astrônomos a investigar o intervalo entre o colapso de nuvens frias de gás e o início da fusão nuclear no interior de uma estrela jovem.

O programa de observação usado na imagem catalogou quase meio milhão de estrelas, incluindo objetos que aparecem à frente da região estudada. Aproximadamente 30 mil foram identificadas como estrelas de pré-sequência principal: ainda não começaram a fundir hidrogênio em hélio no núcleo. A sensibilidade e a resolução dos instrumentos do Hubble permitem distinguir objetos fracos mesmo em campos muito povoados.

## O que a imagem ajuda a explicar
