---
{
  "title": "Bienal do Livro de São Paulo terá maior edição de sua história",
  "slug": "cbl-bienal-do-livro-de-sao-paulo-tera-maior-edicao-de-sua-historia",
  "description": "Bienal do Livro de São Paulo terá maior edição de sua história",
  "quickTakeaways": [
    "Bienal do Livro de São Paulo terá maior edição de sua história.",
    "Fatos e números estão resumidos a partir da fonte indicada.",
    "Acompanhe a fonte original para atualizações e documentos."
  ],
  "publishedAt": "2026-09-08T02:30:00Z",
  ...
  "image": "/images/news/cbl-bienal-do-livro-de-sao-paulo-tera-maior-edicao-de-sua-historia.webp",
  "imageAlt": "Ilustração editorial original sobre: Bienal do Livro de São Paulo terá maior edição de sua história. Não é fotografia do fato.",
  "imageCredit": "Apurante Editorial · Ilustração editorial, não é fotografia.",
  "status": "published",
  "confidence": "CONFIRMADO",
  "relevance": 76,
  "eventKey": "veridia-cbl-bienal-do-livro-de-sao-paulo-tera-maior-edicao-de-sua-historia",
  "sources": [
    {
      "name": "Agência Brasil",
      "url": "https://agenciabrasil.ebc.com.br/cultura/noticia/2026-09/cbl-bienal-do-livro-de-sao-paulo-tera-maior-edicao-de-sua-historia",
...
---
A notícia foi publicada pela Agência Brasil em 2026-09-07. O ponto central é bienal do livro de são paulo terá maior edição de sua história. Esta matéria resume o que está documentado na fonte e separa o fato confirmado do contexto necessário para entendê-lo.
...
O núcleo factual desta publicação é: Bienal do Livro de São Paulo terá maior edição de sua história A redação conferiu esse enunciado com a fonte identificada — Agência Brasil — e manteve no texto apenas informações compatíveis com o material consultado. A referência mais antiga usada nesta edição está datada de 2026-09-07; fatos posteriores precisam de uma atualização separada.
