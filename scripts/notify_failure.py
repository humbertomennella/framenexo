...
if run['conclusion'] not in ('failure','timed_out','cancelled') or run['head_branch']!='main' or run['head_repository']['full_name']!=repo:raise SystemExit(0)
