...
class WorkflowIsolation(unittest.TestCase):
    def test_scout_cannot_commit_or_deploy_and_keeps_clock(self):
        ...
        self.assertIn("'0 1,11,16,21 * * *'",(ROOT/'.github/workflows/collector.yml').read_text())
